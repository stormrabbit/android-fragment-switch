 ...
 * Time: 上午9:25
 */
public class SubFragTabSwitch implements RadioGroup.OnCheckedChangeListener{
    ...
    public SubFragTabSwitch(Fragment fragment, ArrayList<BaseFragment> fragments, int fragmentContentId, RadioGroup rgs) {
